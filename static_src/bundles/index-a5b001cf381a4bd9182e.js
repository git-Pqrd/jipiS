...
const testGal = document.getElementById('test')
const oneGal = document.getElementsByClassName('OeuvreOne')
test.addEventListener('click' , function hello() {
  Object.keys(document.getElementsByClassName('OeuvreOne').map(function(i) {
    document.getElementsByClassName(oneGal)[i].classList.toggle('test');
  }))
  // console.log(oneGal.classList.toggle('test'));
})
