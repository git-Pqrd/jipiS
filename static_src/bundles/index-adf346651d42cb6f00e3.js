...
hammertime = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"hammerjs\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()))
...
// module
exports.push([module.i, "*{box-sizing:border-box}body{background-color:rgba(159,126,92,.2);overflow-x:hidden}body,html{color:#2f2f2f;font-size:16px;margin:0;padding:0;width:100%;height:100%}.bgblock{background:#9f7e5c;width:100%;overflow:hidden}#bghaut{background:#000!important;position:relative;height:100%;background:none;min-height:100%}.skewbar{top:72.5%;width:100%;height:15%;z-index:10;position:absolute}.skewbar .inner-content{padding:10px;display:flex;justify-content:center;text-align:center}.skewbar .inner-content h1{margin:0 15px;background:#ff8000;padding:5px 10px;font-size:1.5em}.full-screen-vid{width:100%;height:100%;position:relative}.full-screen-vid video{margin:auto;position:absolute;top:-5%;left:0;min-height:110%;width:auto}.full-screen-vid .overlay{z-index:2;background:rgba(255,128,0,.2);position:absolute;top:0;left:0;width:100%;height:100%}#img-jipi{margin:7% 0 0 7%;height:125px;width:125px;border-radius:50%;z-index:20;position:relative}.text-intro{box-shadow:-15px 0 15px 10px rgba(47,47,47,.15),0 -15px 15px 10px rgba(47,47,47,.15),15px 0 15px 10px rgba(47,47,47,.15),0 15px 15px 10px rgba(47,47,47,.15);-webkit-box-shadow:-15px 0 15px 10px rgba(47,47,47,.15),0 -15px 15px 10px rgba(47,47,47,.15),15px 0 15px 10px rgba(47,47,47,.15),0 15px 15px 10px rgba(47,47,47,.15);-moz-box-shadow:-15px 0 15px 10px rgba(47,47,47,.15),0 -15px 15px 10px rgba(47,47,47,.15),15px 0 15px 10px rgba(47,47,47,.15),0 15px 15px 10px rgba(47,47,47,.2);background:#ff8000;margin:0 15px 25px;padding:15px 15px 10px;transform:translateY(50px)}.art-block{background:#9f7e5c;margin:25px 20px;padding-bottom:10px}.art-block .art-oeuvre{background:#9f7e5c;box-shadow:-15px 0 15px 10px rgba(47,47,47,.15),0 -15px 15px 10px rgba(47,47,47,.15),15px 0 15px 10px rgba(47,47,47,.15),0 15px 15px 10px rgba(47,47,47,.15);-webkit-box-shadow:-15px 0 15px 10px rgba(47,47,47,.15),0 -15px 15px 10px rgba(47,47,47,.15),15px 0 15px 10px rgba(47,47,47,.15),0 15px 15px 10px rgba(47,47,47,.15);-moz-box-shadow:-15px 0 15px 10px rgba(47,47,47,.15),0 -15px 15px 10px rgba(47,47,47,.15),15px 0 15px 10px rgba(47,47,47,.15),0 15px 15px 10px rgba(47,47,47,.2);display:flex;align-items:center;margin:0 -5px}.art-block .art-oeuvre .img{transform:translateX(-20px);height:300px;width:40%;background-image:url(" + __webpack_require__(5) + ");background-position:50%;background-size:contain;background-repeat:no-repeat}.art-block .art-oeuvre .art-text{width:60%;padding:10px 10px 10px 0;font-weight:300}.art-block .art-oeuvre .art-text .btn{float:right;margin-right:-20px;width:150px;padding:2px;background:#2f2f2f;color:#ff8000;text-align:center;font-size:1.3em}.art-block .gal{color:transparent;max-height:5px!important;display:none}.art-block .gal.showing{max-height:5px!important;display:flex;flex-direction:row;flex-wrap:wrap;min-height:fit-content;background:#000;color:rgba(47,47,47,.5);font-size:2em;text-align:center;margin:15px 5px 5px;line-height:70px}.art-block .gal.showing img{height:auto;width:50%}.motDeFin{padding:5% 15%}.motDeFin h2{text-align:center;font-size:1.7em;margin:0 -15px}.motDeFin p{font-size:1.3em}@keyframes upanddown{0%{transform:scale(1)}40%{transform:scale(.7)}to{transform:scale(1)}}.footer{box-shadow:-15px 0 15px 10px rgba(47,47,47,.15),0 -15px 15px 10px rgba(47,47,47,.15),15px 0 15px 10px rgba(47,47,47,.15),0 15px 15px 10px rgba(47,47,47,.15);-webkit-box-shadow:-15px 0 15px 10px rgba(47,47,47,.15),0 -15px 15px 10px rgba(47,47,47,.15),15px 0 15px 10px rgba(47,47,47,.15),0 15px 15px 10px rgba(47,47,47,.15);-moz-box-shadow:-15px 0 15px 10px rgba(47,47,47,.15),0 -15px 15px 10px rgba(47,47,47,.15),15px 0 15px 10px rgba(47,47,47,.15),0 15px 15px 10px rgba(47,47,47,.2);background:#9f7e5c;z-index:1;margin:20px auto;min-width:90%;min-height:150px;padding:10px;display:flex}.footer a{text-decoration:none;color:inherit}.footer .footer-part ul{padding-left:20px;font-size:1.5em;opacity:.9;margin:0;text-decoration:none;list-style:none}.footer .footer-part ul li{font-size:.7em;padding-left:25px}.footer .right{letter-spacing:1px;padding-top:25px;text-align:right;width:50%;margin-right:25px}.footer .right ul,.footer .right ul>li{padding-left:0}.overflow-hack{height:auto;width:100%;overflow:hidden}.full-slider{margin:auto;display:flex;justify-content:center;flex-direction:column;position:relative;width:100%}.full-slider .slider-moving{height:auto;z-index:1;position:relative;margin:50px 0;display:flex;justify-content:flex-end;transition:transform 1s ease-in-out}.full-slider .slider-moving .modeCom{width:100%;height:100%}.full-slider .slider-moving .modeCom .inner-card{background:#2f2f2f;width:100%;height:100%}.full-slider .slider-moving .modeCom.showing{animation:upanddown 2s forwards ease-in-out}.basecard{box-shadow:-15px 0 15px 10px rgba(47,47,47,.15),0 -15px 15px 10px rgba(47,47,47,.15),15px 0 15px 10px rgba(47,47,47,.15),0 15px 15px 10px rgba(47,47,47,.15);-webkit-box-shadow:-15px 0 15px 10px rgba(47,47,47,.15),0 -15px 15px 10px rgba(47,47,47,.15),15px 0 15px 10px rgba(47,47,47,.15),0 15px 15px 10px rgba(47,47,47,.15);-moz-box-shadow:-15px 0 15px 10px rgba(47,47,47,.15),0 -15px 15px 10px rgba(47,47,47,.15),15px 0 15px 10px rgba(47,47,47,.15),0 15px 15px 10px rgba(47,47,47,.2);position:relative;overflow:hidden;border-radius:10px;display:flex;flex-direction:column;height:50vh;width:50vh;background:#9f7e5c;margin:auto}.basecard .e-haut{border-bottom:2px solid #2f2f2f;height:70%;width:100%;transform:scale(1.01);padding:2% 6%;margin:auto 0;font-size:2.8vh}.basecard .e-bas{padding:0 10px;height:30%;width:100%}.basecard .e-img{border:2px solid #2f2f2f;transition:transform 1s ease-in-out;width:110%;height:70%;position:absolute;background:#2f2f2f;top:0;z-index:2}.basecard .e-map{position:absolute;z-index:3;bottom:25%;right:40px;height:40px;width:120px;border-radius:20px;background:#ff8000;box-shadow:-15px 0 15px 10px rgba(47,47,47,.15),0 -15px 15px 10px rgba(47,47,47,.15),15px 0 15px 10px rgba(47,47,47,.15),0 15px 15px 10px rgba(47,47,47,.15);-webkit-box-shadow:-15px 0 15px 10px rgba(47,47,47,.15),0 -15px 15px 10px rgba(47,47,47,.15),15px 0 15px 10px rgba(47,47,47,.15),0 15px 15px 10px rgba(47,47,47,.15);-moz-box-shadow:-15px 0 15px 10px rgba(47,47,47,.15),0 -15px 15px 10px rgba(47,47,47,.15),15px 0 15px 10px rgba(47,47,47,.15),0 15px 15px 10px rgba(47,47,47,.2);text-align:center;font-size:1.5em;line-height:40px}.basecard .e-map svg{height:100%;width:100%}@media (min-width:750px){body{padding:0}.biographie{padding:10%;font-size:2.5vh}.hidden-m{display:none}#bghaut video{width:100%;height:90%}#bghaut .text-intro{border-radius:5px;margin:auto;width:80%}#bghaut .skewbar{max-width:60%;margin:-20px auto 0}#bghaut .skewbar *{transform:none}.hidden-lg{display:none}.oeuvres-lg{width:100%;margin:auto;display:flex;flex-wrap:wrap;justify-content:center;align-items:flex-start}.oeuvres-lg .art-block{max-width:40%}.full-slider{width:50%;margin-left:auto;margin-right:auto}.footer{margin:40px;border-radius:10px}}", ""]);
