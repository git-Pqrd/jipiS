...
const btnUn = document.getElementsById('btnUn');
const btnDeux = document.getElementsById('btnDeux');
const btnTroi = document.getElementsById('btnTroi');
const btnQuat = document.getElementsById('btnnQuat');
...
btnUn.addEventListener('click'  , console.log('hello'));
btnDeux.addEventListener('click'  , console.log('hello'));
btnTroi.addEventListener('click'  , console.log('hello'));
btnQuat.addEventListener('click'  , console.log('hello'));
