...
module.exports = "{% extends \"base.html\" %} {% load render_bundle from webpack_loader %} {% block content %} <h1>hello</h1> {% render_bundle 'index' %} {% endblock content %} ";
...
// module
exports.push([module.i, "h1{background-color:#ff4136}", ""]);
